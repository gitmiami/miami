======================================
CD-ROMをお使いになる前にお読みください
======================================

●本CD-ROMについて

本CD-ROMには『10日でおぼえるJava　オブジェクト指向入門教室 Java 
2 SDK対応』の本文中で解説した各レッスンの完成ファイルが入ってい
ますのでお使いのコンピュータにコピーしてお使いください。また、
CD-ROMから直接コピーしたものは「読み取り専用」の属性が付いており、
ファイルの中身を修正したりする場合には「読み取り専用」の属性を
はずしてからご使用ください。

「読み取り専用」の属性をはずすには、エクスプローラから目的のファ
イルを右クリックして出てくるメニューの［プロパティ］を選び、［読
み取り専用］のチェックをはずします。

●免責事項について

本CD-ROMに収録されたファイルは通常の運用においては何ら問題ないこ
とを編集部では確認していますが、万一運用の結果、いかなる損害が発
生したとしても著者及び（株）翔泳社はいかなる責任も負いません。す
べて自己責任においてご使用ください。

●本CD-ROMの使用環境条件

本CD-ROMの全レッスンを使用するには「Java 2 SDK Standard Editon
1.4」が必要です。これはJ2SEフォルダに収録されいているので、必ずイ
ンストールしてください。その際にはJ2SEフォルダにあるREADME.txtを
必ずお読みください。

●本CD-ROMの構成

＜JAVAOBCD＞
　+-- J2SE【Java 2 SDK Standard Editon 1.4 Windows版】
　+-- Java10Obj【本書使用サンプルプログラム】
	+-- Day01【第1日サンプルプログラム】
　　　　　　　+-- Lesson01～05
			+-- Lesson01～05.java
	+-- Day02【第2日サンプルプログラム】
...
　　　　　　　　　　：
              +-- Day08qa
　+-- README.txt【本CD-ROMについて：最初にお読みください】

●著作権等について

本書に収録したプログラムおよびソースコードの著作権は、著者である
丸の内とら氏および翔泳社に帰属します。

2003/3 (株) 翔泳社 編集部


Java(TM) 2 Software Development Kit Standard Edition (JDK)1.4.1_01は
米国Sun Microsystems社の製品です。
下記Binary License and Distribution AgeementはJDKに対してのみ適用されます。
---------------------------------------------------------------------------
Sun Microsystems, Inc. 
Binary Code License Agreement

READ THE TERMS OF THIS AGREEMENT AND ANY PROVIDED SUPPLEMENTAL LICENSE TERMS (COLLECTIVELY "AGREEMENT") CAREFULLY BEFORE OPENING THE SOFTWARE MEDIA PACKAGE.  BY OPENING THE SOFTWARE MEDIA PACKAGE, YOU AGREE TO THE TERMS OF THIS AGREEMENT.  IF YOU ARE ACCESSING THE SOFTWARE ELECTRONICALLY, INDICATE YOUR ACCEPTANCE OF THESE TERMS BY SELECTING THE "ACCEPT" BUTTON AT THE END OF THIS AGREEMENT.  IF YOU DO NOT AGREE TO ALL THESE TERMS, PROMPTLY RETURN THE UNUSED SOFTWARE TO YOUR PLACE OF PURCHASE FOR A REFUND OR, IF THE SOFTWARE IS ACCESSED
...
representative of each party.
   ...
   JAVA(TM) 2 SOFTWARE DEVELOPMENT KIT (J2SDK), STANDARD EDITION, VERSION 1.4.X
