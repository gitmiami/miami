...
public class rcvMail_desc extends HttpServlet {
	public void doGet(HttpServletRequest request,HttpServletResponse response)
		...
		try {
			...
			out.print("<tr><th>件名</th><td>" + objMsg.getSubject() + "</td></tr>");
			out.print("<tr><th>送信者</th><td>" + BeanEncode.htmlEncode(MimeUtility.decodeText(objFrm[0].toString())) + "</td></tr>");
			out.print("<tr><th>送信日</th><td>" + objMsg.getSentDate() + "</td></tr>");
			out.print("<tr><th valign='top'>本文</th><td><pre>" + objMsg.getContent() + "</pre></td></tr>");
